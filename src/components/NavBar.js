...
const NavBar = () => {
  ...
  return (
    ...
    dark:text-dark relative z-10 lg:px-16 md:px-12 sm:px-8
    "
    >
      <button
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          ...
          <motion.a
            href="https://www.linkedin.com/in/toryredner/"
            target={"_blank"}
            className="w-6 mx-3"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
      ...
      bg-light/90 dark:bg-dark/75 rounded-lg backdrop-blur-md py-32 text-dark dark:text-dark
      "
        >
